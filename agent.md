...
- Manual verification input should happen inside the projected terminal, not in a separate form control.
...
- Idle prompts should stay inside the terminal projection and should not be duplicated.
